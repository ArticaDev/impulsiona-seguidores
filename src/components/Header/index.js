...
const Header = ({ className, pageUrl }) => {
    ...
    let props = useSpring({ ref: springApi, from: { height: 0, opacity: 0 }, to: { height: showMenu ? 150 : 0, opacity: showMenu ? 1 : 0 } })
                ...
                <div className="container-fluid h-full flex items-center ">
                    ...
                    <div className={"flex flex-row w-3/5 justify-around mx-auto " + className}>
                        ...
                        <>
                                ...
                                <a activeclass="active" href="https://cliente.impulsionaseguidores.net/" className="flex items-center text-white hover:text-green  text active:text-green">Login</a>
                                </>
                                }
                        {!(pageUrl.includes("blog")) &&
                        <>
